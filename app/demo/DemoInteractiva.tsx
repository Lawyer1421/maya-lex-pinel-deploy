      ...
      {!casoSeleccionado ? (
        ...
        <div className="mt-8">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <Link href="/login?next=/chat&intent=signup" className="rounded-xl bg-jade-deep px-6 py-3 text-center text-sm font-semibold text-white shadow-lg shadow-jade/20 hover:bg-jade-dark focus-visible:ring-2 focus-visible:ring-jade focus-visible:ring-offset-2 focus-visible:ring-offset-obsidian">
