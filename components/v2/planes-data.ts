...
export const PLANES_V2: PlanV2[] = [
  ...
  },
  {
    ...
    caracteristicas: [
      'Propuesta a medida — no es autoservicio',
      'Cuenta de trabajo para el despacho',
      'Lista de espera: biblioteca privada de plantillas',
      'Soporte directo del fundador',
    ],
    notaUsoRazonable: 'Bufete se implementa con nosotros. No cobra usuarios extra ni panel multi-sede desde la tarjeta.',
  ...
  },
  {
    ...
    caracteristicas: [
      'Licencias coordinadas para docentes y estudiantes',
      'Capacitación de arranque incluida',
      'Mismo producto verificado — cupos según convenio',
    ],
    notaUsoRazonable: 'Universidad se contrata por convenio. No hay panel académico self-serve hoy.',
